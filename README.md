...
<br/>
<br/>
Hence when I do not use reserve():<br/>
1. The vector starts small.<br/>
2. Each time the vector runs out of capacity, it allocates a bigger block of memory.<br/>
3. Then it copies or moves all existing elements into the new block.<br/>
4. The old memory is freed.<br/>
